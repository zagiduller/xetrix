...
func (o *CreateOrderParams) WithBody(body *models.OrderQueryOrder) *CreateOrderParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create order params
func (o *CreateOrderParams) SetBody(body *models.OrderQueryOrder) {
	o.Body = body
}
