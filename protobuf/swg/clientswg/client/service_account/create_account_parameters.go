...
type CreateAccountParams struct {
	...
	/*Body*/
	Body *models.OrderQueryCreateAccount
...
func (o *CreateAccountParams) WithBody(body *models.OrderQueryCreateAccount) *CreateAccountParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create account params
func (o *CreateAccountParams) SetBody(body *models.OrderQueryCreateAccount) {
	o.Body = body
}
